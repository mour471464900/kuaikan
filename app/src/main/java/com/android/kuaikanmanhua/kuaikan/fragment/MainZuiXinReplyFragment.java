...
//评论最新的回复界面
public class MainZuiXinReplyFragment extends Fragment {
    ...
    public static MainZuiXinReplyFragment newInstance(Bundle args) {
        MainZuiXinReplyFragment fragment = new MainZuiXinReplyFragment();
    ...
    private void initData() {
        ...
        OkHttpTool.newInstance().start(URLConstants.URL_ZUI_XING_START+feedId+URLConstants.URL_ZUI_XING_END).callback(new IOKCallBack() {
            @Override
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            int likes_count = sBean.get(position).getLikes_count();
            if(likes_count >10){
                viewHolder.like.setText(""+ likes_count);
            }else {
