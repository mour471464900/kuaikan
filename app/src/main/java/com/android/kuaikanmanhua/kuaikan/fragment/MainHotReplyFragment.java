...
public class MainHotReplyFragment extends Fragment{
    ...
    public static MainHotReplyFragment newInstance(Bundle args) {
        MainHotReplyFragment fragment = new MainHotReplyFragment();
