...
import com.android.kuaikanmanhua.kuaikan.fragment.MainHotReplyFragment;
import com.android.kuaikanmanhua.kuaikan.fragment.MainZuiXinReplyFragment;
...
public class MainReplyActivity extends AppCompatActivity {
   ...
   @BindView(R.id.rb_comment_hot_1)
    ...
    private void initBean() {
        ...
        if(intent!=null){
            feedId=intent.getIntExtra("id",0);
        }
    }
...
//        判定适配器
    ...
    class ReplyAdapter extends FragmentPagerAdapter {
        ...
        private void initFragment() {
            ...
            MainHotReplyFragment fragment1 = MainHotReplyFragment.newInstance(bundle);
            MainZuiXinReplyFragment fragment2 =MainZuiXinReplyFragment.newInstance(bundle);
